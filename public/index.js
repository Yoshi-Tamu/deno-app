...
const modes = {
  ...
  nebula: {
    name: "nebula",
    colors: ["#ff8bd4", "#7cf7ff", "#b18cff", "#ffffff"],
    ambientRate: 0.998,
    moveBurst: 10,
    downBurst: 52,
    clickBurst: 36,
  ...
  laser: {
    name: "laser",
    colors: ["#7cf7ff", "#00ffd5", "#ffffff", "#ff8bd4"],
    ambientRate: 0.999,
    moveBurst: 14,
    downBurst: 70,
    clickBurst: 48,
...
window.addEventListener("scroll", () => {
  burst(
    Math.random() * width,
    60 + Math.random() * Math.max(80, height * 0.18),
    currentMode.scrollBurst,
    0.95,
  );
});
